...
let totalShoppingCart2 = parseInt(prompt('Inserisci un numero!'));
let spedizione = 10;

if(totalShoppingCart2 != null && totalShoppingCart2 >= 50){
  console.log('Hai diritto allo sconto del 20% su ogni prodotto');
  console.log('Hai diritto alla spedizione gratuita');
}else{
  let nuovoTotale = totalShoppingCart + spedizione;
  console.log('Hai diritto allo sconto del 20% su ogni prodotto');
  console.log("NON hai diritto alla spedizione gratuita, l'importo è maggiorato di 10 euro. Quindi spendi " + nuovoTotale);
}
